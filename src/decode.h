...
typedef arg_decode7 arg_prefix;
...
typedef arg_decode8 arg_fcmp;
static bool trans_fcmp(DisasContext *ctx, arg_fcmp *a);
typedef arg_decode8 arg_fcmpi;
...
typedef arg_decode8 arg_scmp;
static bool trans_scmp(DisasContext *ctx, arg_scmp *a);
typedef arg_decode8 arg_scmpi;
...
static void decode_extract_decode_Fmt_10(DisasContext *ctx, arg_decode9 *a, uint32_t insn)
{
    a->cond = extract32(insn, 29, 3);
...
static void decode_extract_decode_Fmt_15(DisasContext *ctx, arg_decode10 *a, uint32_t insn)
{
    a->cond = extract32(insn, 29, 3);
...
static void decode_extract_decode_Fmt_16(DisasContext *ctx, arg_decode14 *a, uint32_t insn)
{
...
static void decode_extract_decode_Fmt_9(DisasContext *ctx, arg_decode1 *a, uint32_t insn)
{
    a->cond = extract32(insn, 29, 3);
    a->r1 = extract32(insn, 0, 5);
}
...
static bool decode(DisasContext *ctx, uint32_t insn)
{
    ...
    case 0x1:
        ...
        case 0x1:
            ...
            case 0x0:
                ...
                case 0x0:
                    /* ...01... ........ ....0100 0....... */
                    /* hive64.decode:125 */
                    if (trans_ubxt(ctx, &u.f_decode14)) return true;
                    break;
                case 0x1:
                    /* ...01... ........ ....0100 1....... */
                    /* hive64.decode:126 */
                    if (trans_sbxt(ctx, &u.f_decode14)) return true;
                    break;
                }
                break;
            case 0x1:
                ...
                case 0x0:
                    /* ...01... ........ ....0101 0....... */
                    /* hive64.decode:127 */
                    if (trans_ubdp(ctx, &u.f_decode14)) return true;
                    break;
                case 0x1:
                    /* ...01... ........ ....0101 1....... */
                    /* hive64.decode:128 */
                    if (trans_sbdp(ctx, &u.f_decode14)) return true;
                    break;
                }
                break;
            case 0x3:
                ...
                case 0x0:
                    ...
                    if (trans_vadd(ctx, &u.f_decode15)) return true;
                    break;
                case 0x1:
                    /* ...01000 1....... ....0111 ........ */
                    /* hive64.decode:132 */
                    decode_extract_decode_Fmt_17(ctx, &u.f_decode15, insn);
                    if (trans_vsub(ctx, &u.f_decode15)) return true;
                    break;
                case 0x2:
                    /* ...01001 0....... ....0111 ........ */
                    /* hive64.decode:133 */
                    decode_extract_decode_Fmt_17(ctx, &u.f_decode15, insn);
                    if (trans_vmul(ctx, &u.f_decode15)) return true;
                    break;
                case 0x3:
                    /* ...01001 1....... ....0111 ........ */
                    /* hive64.decode:134 */
                    decode_extract_decode_Fmt_17(ctx, &u.f_decode15, insn);
                    if (trans_vdiv(ctx, &u.f_decode15)) return true;
                    break;
                case 0x4:
                    /* ...01010 0....... ....0111 ........ */
                    /* hive64.decode:135 */
                    decode_extract_decode_Fmt_17(ctx, &u.f_decode15, insn);
                    if (trans_vaddsub(ctx, &u.f_decode15)) return true;
                    break;
                case 0x5:
                    /* ...01010 1....... ....0111 ........ */
                    /* hive64.decode:136 */
                    decode_extract_decode_Fmt_17(ctx, &u.f_decode15, insn);
                    if (trans_vmadd(ctx, &u.f_decode15)) return true;
                    break;
                case 0x6:
                    /* ...01011 0....... ....0111 ........ */
                    /* hive64.decode:137 */
                    decode_extract_decode_Fmt_18(ctx, &u.f_decode16, insn);
                    if (trans_vmov_reg(ctx, &u.f_decode16)) return true;
                    break;
                case 0x7:
                    /* ...01011 1....... ....0111 ........ */
                    /* hive64.decode:138 */
                    decode_extract_decode_Fmt_19(ctx, &u.f_decode17, insn);
                    if (trans_vmov(ctx, &u.f_decode17)) return true;
                    break;
                case 0x8:
                    /* ...01100 0....... ....0111 ........ */
                    /* hive64.decode:139 */
                    decode_extract_decode_Fmt_20(ctx, &u.f_decode18, insn);
                    if (trans_vconv(ctx, &u.f_decode18)) return true;
                    break;
                case 0x9:
                    /* ...01100 1....... ....0111 ........ */
                    /* hive64.decode:140 */
                    decode_extract_decode_Fmt_21(ctx, &u.f_decode19, insn);
                    if (trans_vlen(ctx, &u.f_decode19)) return true;
                    break;
                case 0xa:
                    /* ...01101 0....... ....0111 ........ */
                    switch ((insn >> 21) & 0x3) {
                    case 0x0:
                        ...
                        if (trans_vldr_reg(ctx, &u.f_decode21)) return true;
                        break;
                    case 0x1:
                        /* ...01101 001..... ....0111 ........ */
                        /* hive64.decode:146 */
                        decode_extract_decode_Fmt_23(ctx, &u.f_decode21, insn);
                        if (trans_vldr_reg_update(ctx, &u.f_decode21)) return true;
                        break;
                    case 0x2:
                        /* ...01101 010..... ....0111 ........ */
                        /* hive64.decode:141 */
                        decode_extract_decode_Fmt_22(ctx, &u.f_decode20, insn);
                        if (trans_vldr_imm(ctx, &u.f_decode20)) return true;
                        break;
                    case 0x3:
                        /* ...01101 011..... ....0111 ........ */
                        /* hive64.decode:142 */
                        decode_extract_decode_Fmt_22(ctx, &u.f_decode20, insn);
                        if (trans_vldr_imm_update(ctx, &u.f_decode20)) return true;
                        break;
                    }
                    break;
                case 0xb:
                    ...
                    case 0x0:
                        ...
                        /* hive64.decode:147 */
                        decode_extract_decode_Fmt_23(ctx, &u.f_decode21, insn);
                        if (trans_vstr_reg(ctx, &u.f_decode21)) return true;
                        break;
                    case 0x1:
                        /* ...01101 101..... ....0111 ........ */
                        /* hive64.decode:148 */
                        decode_extract_decode_Fmt_23(ctx, &u.f_decode21, insn);
                        if (trans_vstr_reg_update(ctx, &u.f_decode21)) return true;
                        break;
                    case 0x2:
                        /* ...01101 110..... ....0111 ........ */
                        /* hive64.decode:143 */
                        decode_extract_decode_Fmt_22(ctx, &u.f_decode20, insn);
                        if (trans_vstr_imm(ctx, &u.f_decode20)) return true;
                        break;
                    case 0x3:
                        /* ...01101 111..... ....0111 ........ */
                        /* hive64.decode:144 */
                        decode_extract_decode_Fmt_22(ctx, &u.f_decode20, insn);
                        if (trans_vstr_imm_update(ctx, &u.f_decode20)) return true;
                        break;
                    }
                    break;
                }
        ...
        case 0x2:
            ...
            case 0x00c00000:
                ...
                if (trans_fcmp(ctx, &u.f_decode8)) return true;
                break;
            case 0x00c00040:
                /* ...01000 11...... ....1000 01...... */
                /* hive64.decode:77 */
                decode_extract_decode_Fmt_8(ctx, &u.f_decode8, insn);
                if (trans_scmp(ctx, &u.f_decode8)) return true;
                break;
            case 0x00c00080:
                /* ...01000 11...... ....1000 10...... */
                /* hive64.decode:60 */
                decode_extract_decode_Fmt_8(ctx, &u.f_decode8, insn);
                if (trans_fcmpi(ctx, &u.f_decode8)) return true;
                break;
            case 0x00c000c0:
                /* ...01000 11...... ....1000 11...... */
                /* hive64.decode:78 */
                decode_extract_decode_Fmt_8(ctx, &u.f_decode8, insn);
                if (trans_scmpi(ctx, &u.f_decode8)) return true;
                break;
            case 0x01000000:
                /* ...01001 00...... ....1000 00...... */
                /* hive64.decode:61 */
    ...
    case 0x2:
        ...
        case 0x0:
            ...
            if (trans_lea(ctx, &u.f_decode10)) return true;
            break;
        case 0x1:
            /* ...1001. ........ ........ ........ */
            ...
            case 0x0:
                /* ...1001. .....000 ........ ........ */
                /* hive64.decode:104 */
                if (trans_movz_0(ctx, &u.f_decode11)) return true;
                break;
            case 0x1:
                /* ...1001. .....001 ........ ........ */
                /* hive64.decode:105 */
                if (trans_movz_16(ctx, &u.f_decode11)) return true;
                break;
            case 0x2:
                /* ...1001. .....010 ........ ........ */
                /* hive64.decode:106 */
                if (trans_movz_32(ctx, &u.f_decode11)) return true;
                break;
            case 0x3:
                /* ...1001. .....011 ........ ........ */
                /* hive64.decode:107 */
                if (trans_movz_48(ctx, &u.f_decode11)) return true;
                break;
            case 0x4:
                /* ...1001. .....100 ........ ........ */
                /* hive64.decode:108 */
                if (trans_movk_0(ctx, &u.f_decode11)) return true;
                break;
            case 0x5:
                /* ...1001. .....101 ........ ........ */
                /* hive64.decode:109 */
                if (trans_movk_16(ctx, &u.f_decode11)) return true;
                break;
            case 0x6:
                /* ...1001. .....110 ........ ........ */
                /* hive64.decode:110 */
                if (trans_movk_32(ctx, &u.f_decode11)) return true;
                break;
            case 0x7:
                /* ...1001. .....111 ........ ........ */
                /* hive64.decode:111 */
                if (trans_movk_48(ctx, &u.f_decode11)) return true;
                break;
            }
            break;
        case 0x2:
            ...
            case 0x0:
                ...
                if (trans_ldr_reg(ctx, &u.f_decode12)) return true;
                break;
            case 0x1:
                /* ...1010. ....001. ........ ........ */
                /* hive64.decode:114 */
                decode_extract_decode_Fmt_13(ctx, &u.f_decode12, insn);
                if (trans_ldr_reg_update(ctx, &u.f_decode12)) return true;
                break;
            case 0x2:
                /* ...1010. ....010. ........ ........ */
                /* hive64.decode:115 */
                decode_extract_decode_Fmt_14(ctx, &u.f_decode13, insn);
                if (trans_ldr_imm(ctx, &u.f_decode13)) return true;
                break;
            case 0x3:
                /* ...1010. ....011. ........ ........ */
                /* hive64.decode:116 */
                decode_extract_decode_Fmt_14(ctx, &u.f_decode13, insn);
                if (trans_ldr_imm_update(ctx, &u.f_decode13)) return true;
                break;
            case 0x4:
                /* ...1010. ....100. ........ ........ */
                /* hive64.decode:117 */
                decode_extract_decode_Fmt_13(ctx, &u.f_decode12, insn);
                if (trans_str_reg(ctx, &u.f_decode12)) return true;
                break;
            case 0x5:
                /* ...1010. ....101. ........ ........ */
                /* hive64.decode:118 */
                decode_extract_decode_Fmt_13(ctx, &u.f_decode12, insn);
                if (trans_str_reg_update(ctx, &u.f_decode12)) return true;
                break;
            case 0x6:
                /* ...1010. ....110. ........ ........ */
                /* hive64.decode:119 */
                decode_extract_decode_Fmt_14(ctx, &u.f_decode13, insn);
                if (trans_str_imm(ctx, &u.f_decode13)) return true;
                break;
            case 0x7:
                /* ...1010. ....111. ........ ........ */
                /* hive64.decode:120 */
                decode_extract_decode_Fmt_14(ctx, &u.f_decode13, insn);
                if (trans_str_imm_update(ctx, &u.f_decode13)) return true;
                break;
            }
            break;
        case 0x3:
            /* ...1011. ........ ........ ........ */
            decode_extract_decode_Fmt_15(ctx, &u.f_decode10, insn);
            switch ((insn >> 19) & 0x1) {
            case 0x0:
                /* ...1011. ....0... ........ ........ */
                /* hive64.decode:121 */
                if (trans_ldr_pc_rel(ctx, &u.f_decode10)) return true;
                break;
            case 0x1:
                /* ...1011. ....1... ........ ........ */
                /* hive64.decode:122 */
                if (trans_str_pc_rel(ctx, &u.f_decode10)) return true;
                break;
            }
            break;
        }
    ...
    case 0x3:
        ...
        case 0x1:
            ...
            case 0x3:
                /* 01111000 01...... ........ ........ */
                /* hive64.decode:53 */
                if (trans_prefix(ctx, &u.f_decode7)) return true;
                break;
            }
            break;
        case 0x2:
            /* ...11000 10...... ........ ........ */
            /* hive64.decode:95 */
            decode_extract_decode_Fmt_9(ctx, &u.f_decode1, insn);
        ...
        case 0x7:
            ...
            if (trans_mov_cr_r(ctx, &u.f_decode9)) return true;
            break;
        case 0x8:
            /* ...11010 00...... ........ ........ */
            /* hive64.decode:101 */
            decode_extract_decode_Fmt_10(ctx, &u.f_decode9, insn);
            if (trans_mov_r_cr(ctx, &u.f_decode9)) return true;
            break;
        }
        break;
    }
