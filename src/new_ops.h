...
#define op_qadd_reg_imm         OPC(4, opcode_qadd)        // qadd (b|w|d|q|float|double) xmm1 0x1234                           // 0x427 0x(01|02|04|08|10|20) 0x01 0x12 0x34
#define op_qsub_reg_imm         OPC(4, opcode_qsub)        // qsub (b|w|d|q|float|double) xmm1 0x1234                           // 0x428 0x(01|02|04|08|10|20) 0x01 0x12 0x34
#define op_qmul_reg_imm         OPC(4, opcode_qmul)        // qmul (b|w|d|q|float|double) xmm1 0x1234                           // 0x429 0x(01|02|04|08|10|20) 0x01 0x12 0x34
#define op_qdiv_reg_imm         OPC(4, opcode_qdiv)        // qdiv (b|w|d|q|float|double) xmm1 0x1234                           // 0x42A 0x(01|02|04|08|10|20) 0x01 0x12 0x34
#define op_qmod_reg_imm         OPC(4, opcode_qmod)        // qmod (b|w|d|q|float|double) xmm1 0x1234                           // 0x42B 0x(01|02|04|08|10|20) 0x01 0x12 0x34
#define op_qand_reg_imm         OPC(4, opcode_qand)        // qand (b|w|d|q|float|double) xmm1 0x1234                           // 0x42C 0x(01|02|04|08|10|20) 0x01 0x12 0x34
#define op_qor_reg_imm          OPC(4, opcode_qor)         // qor (b|w|d|q|float|double) xmm1 0x1234                            // 0x42D 0x(01|02|04|08|10|20) 0x01 0x12 0x34
#define op_qxor_reg_imm         OPC(4, opcode_qxor)        // qxor (b|w|d|q|float|double) xmm1 0x1234                           // 0x42E 0x(01|02|04|08|10|20) 0x01 0x12 0x34
#define op_qshl_reg_imm         OPC(4, opcode_qshl)        // qshl (b|w|d|q|float|double) xmm1 0x1234                           // 0x42F 0x(01|02|04|08|10|20) 0x01 0x12 0x34
#define op_qshr_reg_imm         OPC(4, opcode_qshr)        // qshr (b|w|d|q|float|double) xmm1 0x1234                           // 0x430 0x(01|02|04|08|10|20) 0x01 0x12 0x34
#define op_qaddsub_reg_imm      OPC(4, opcode_qaddsub)     // qaddsub (b|w|d|q|float|double) xmm1 0x1234                        // 0x432 0x(01|02|04|08|10|20) 0x01 0x12 0x34
#define op_qshuf_reg_imm        OPC(4, opcode_qshuf)       // qshuf (b|w|d|q|float|double) xmm1 0x1234                          // 0x433 0x(01|02|04|08|10|20) 0x01 0x12 0x34
...
#define op_qadd_reg_sisd        OPC(5, opcode_qadd)        // qadd (b|w|d|q|float|double) xmm1 r2                               // 0x427 0x(01|02|04|08|10|20) 0x01 0x02 0x00 0x00
#define op_qsub_reg_sisd        OPC(5, opcode_qsub)        // qsub (b|w|d|q|float|double) xmm1 r2                               // 0x428 0x(01|02|04|08|10|20) 0x01 0x02 0x00 0x00
#define op_qmul_reg_sisd        OPC(5, opcode_qmul)        // qmul (b|w|d|q|float|double) xmm1 r2                               // 0x429 0x(01|02|04|08|10|20) 0x01 0x02 0x00 0x00
#define op_qdiv_reg_sisd        OPC(5, opcode_qdiv)        // qdiv (b|w|d|q|float|double) xmm1 r2                               // 0x42A 0x(01|02|04|08|10|20) 0x01 0x02 0x00 0x00
#define op_qmod_reg_sisd        OPC(5, opcode_qmod)        // qmod (b|w|d|q|float|double) xmm1 r2                               // 0x42B 0x(01|02|04|08|10|20) 0x01 0x02 0x00 0x00
#define op_qand_reg_sisd        OPC(5, opcode_qand)        // qand (b|w|d|q|float|double) xmm1 r2                               // 0x42C 0x(01|02|04|08|10|20) 0x01 0x02 0x00 0x00
#define op_qor_reg_sisd         OPC(5, opcode_qor)         // qor (b|w|d|q|float|double) xmm1 r2                                // 0x42D 0x(01|02|04|08|10|20) 0x01 0x02 0x00 0x00
#define op_qxor_reg_sisd        OPC(5, opcode_qxor)        // qxor (b|w|d|q|float|double) xmm1 r2                               // 0x42E 0x(01|02|04|08|10|20) 0x01 0x02 0x00 0x00
#define op_qshl_reg_sisd        OPC(5, opcode_qshl)        // qshl (b|w|d|q|float|double) xmm1 r2                               // 0x42F 0x(01|02|04|08|10|20) 0x01 0x02 0x00 0x00
#define op_qshr_reg_sisd        OPC(5, opcode_qshr)        // qshr (b|w|d|q|float|double) xmm1 r2                               // 0x430 0x(01|02|04|08|10|20) 0x01 0x02 0x00 0x00
#define op_qaddsub_reg_sisd     OPC(5, opcode_qaddsub)     // qaddsub (b|w|d|q|float|double) xmm1 r2                            // 0x432 0x(01|02|04|08|10|20) 0x01 0x02 0x00 0x00
#define op_qshuf_reg_sisd       OPC(5, opcode_qshuf)       // qshuf (b|w|d|q|float|double) xmm1 r2                              // 0x433 0x(01|02|04|08|10|20) 0x01 0x02 0x00 0x00
...
#define op_qmov_reg_addr        OPC(8, opcode_qmov)        // qmov (b|w|d|q|float|double) xmm1 [label (0x1234)]                 // 0x434 0x(01|02|04|08|10|20) 0x01 (label address in data(32 bit)) 0x12 0x34
